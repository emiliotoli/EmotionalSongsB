...
public class ConnessioneDBImpl extends UnicastRemoteObject implements ConnessioneDBInterface {
    ...
    // "jdbc:postgresql://localhost:5432/EmotionalSongs_lab_B";
    /*
     ...
     *
     * @throws RemoteException Lanciato in caso di errore nella gestione delle
     *                         operazioni remote.
     */
     ...
     *
     * @return conUn oggetto 'Connection' che rappresenta una connessione al
     *         database.
