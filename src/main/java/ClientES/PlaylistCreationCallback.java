 ...
 *         Interfaccia per la gestione dei risultati della creazione di una
 *         playlist.
 *
 *         Questa interfaccia definisce un metodo di callback che verrà chiamato
 *         quando il risultato del tentativo di creazione di una playlist sarà
 *         disponibile.
 */
public interface PlaylistCreationCallback {
    ...
    /**
     * @author Emilio Daverio
     *         Questo metodo viene chiamato quando il risultato della creazione di
     *         una playlist è disponibile.
     *
