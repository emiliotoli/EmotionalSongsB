 ...
 *         La classe Canzone rappresenta una canzone e contiene informazioni su
 *         di essa, come il titolo, l'autore e l'anno di pubblicazione.
 *         Gli oggetti Canzone vengono utilizzati per la gestione delle canzoni
...
public class Canzone implements Serializable {
    ...
    /**
     * @author Emilio Daverio
     *         Costruttore per la classe Canzone che permette la creazione di un
     *         oggetto Canzone specificando il titolo, l'autore e l'anno di
     *         pubblicazione.
     *
     ...
     * @author Emilio Daverio
     *         Costruttore per la classe Canzone che permette la creazione di un
     *         oggetto Canzone specificando il titolo e l'autore.
     *
     * @param name   Il titolo della canzone.
     * @param autore L'autore della canzone.
     */
