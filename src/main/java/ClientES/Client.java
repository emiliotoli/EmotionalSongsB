...
public class Client implements MetodiControlli_Client {
    ...
    /**
     * @author
     *         Questo metodo serve per gestire le varie operazioni del client e
     *         ricevere le rosposte del server
     * @throws IOException
        ...
        do {
            ...
            switch (sceltaUtente) {
                ...
                case 3:
                    ...
                    registrazione(nome, cognome, codiceFiscale, via, numeroCivico, cap, comune, provincia, email,
                            userID, password, p2);
                    break;
    ...
    public static boolean inserisciNuovaEmozione(String emozioneScelta, String notaEmozione)
            throws IOException, SQLException {
        ...
        if (isLoggato) {
            ...
            if (titoloCanzone != null && autoreCanzone != null) {
                ...
                emozioniPerCanzone = interfaceLoggato.inserisciEmozione(idGlobale, emozioneScelta, titoloCanzone,
                        autoreCanzone, notaEmozione, spiegazioneEmozione, punteggioEmozione);
                return true;
            }
        } else {
...
=======
        ...
        controlloNomePlaylist = interfaceLoggato.checkNomePlaylist(nomePlaylist);
        if (controlloNomePlaylist) {
            cancellazioneCanzonePlaylist = interfaceLoggato.eliminaCanzoniPlaylist(nomePlaylist, userID, titoloCanzone,
                    autoreCanzone);
            if (cancellaPlaylist) {
                return 0; // cancellazione effettuata con successo
            } else {
...
>>>>>>> Stashed changes
    ...
    public static ArrayList<Canzone> ricercaCanzoneTitoloInPlaylist(String idUtente, String titoloCanzone,
            String autoreCanzone) throws RemoteException, SQLException {
        accessoServerLoggato();
        if (interfaceNonLoggato == null) {
            System.out.println("L'interfaccia non è stata inizializzata correttamente");
        ...
        informazioniCanzoneTitoloinPlaylist = (ArrayList<Canzone>) interfaceLoggato
                .ricercaCanzoneTitoloInPlaylist(idUtente, titoloCanzone, autoreCanzone);
