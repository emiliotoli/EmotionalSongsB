...
public class Client implements MetodiControlli_Client {
    ...
    public void inserisciNuovaEmozione() throws IOException, SQLException {
        ...
        if (titoloCanzone != null && autoreCanzone != null) {
            ...
            inserimentoEmozione = interfaceLoggato.inserisciEmozione(userID, emozioneScelta, titoloCanzone,
    ...
    public void login() throws IOException {
        ...
        do {
            ...
            if (isLoggato) {
                ...
                System.out.println(
                        "Dati digitati non corretti. Tentativo " + tentativieffetuati + "/" + maxTentativi + "\n");
            }
        } while (!isLoggato && tentativieffetuati < maxTentativi);

        if (!isLoggato) {
            System.out.println(
                    "---------------Hai raggiunto il limite massimo di tentativi. Ritorno al menu principale.---------------"
                            + "\n");
        }
    }
