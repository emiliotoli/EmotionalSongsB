...
/**
 * L'interfaccia 'ServerInterfaceNonLoggato' definisce i metodi per gestire le
 * operazioni che un utente può eseguire
 * senza essere autenticato. Questi metodi includono registrazione, accesso,
 * ricerca di canzoni e visualizzazione
...
public interface ServerInterfaceNonLoggato extends Remote {
    ...
    /**
     * @author Emilio Daverio
     *         Metodo che serve per registrare un nuovo utente nell'applicazione.
     *         Prende come argomento un oggetto di tipo Utente
     *
     * @param utente Oggetto 'Utente' contenente le informazioni dell'utente da
     *               registrare.
     *
    ...
    /**
     * @author Emilio Daverio
     *         Metodo che effettua l'accesso di un utente con il suo identificativo
     *         e la password.
     *
     ...
     *
     * @return Una lista di oggetti 'Canzone' che corrispondono al titolo
     *         specificato e che contiene tutte le informazioni associate alla
     *         canzone.
     *
     * @throws RemoteException Lanciato in caso di errore durante l'invocazione
     *                         remota.
     ...
     *
     * @return Una lista di oggetti 'Canzone' che corrispondono all'autore e
     *         all'anno specificati e che contiene tutte le informazioni associate
     *         alla canzone.
     *
     * @throws RemoteException Lanciato in caso di errore durante l'invocazione
     *                         remota.
