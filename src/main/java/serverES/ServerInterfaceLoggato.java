...
/**
 * L'interfaccia 'ServerInterfaceLoggato' definisce i metodi per gestire le operazioni consentite
 * solo agli utenti che hanno effettuato il login. Queste operazioni includono la gestione delle playlist,
 * l'aggiunta o l'eliminazione di canzoni dalle playlist, la visualizzazione delle canzoni e delle playlist,
