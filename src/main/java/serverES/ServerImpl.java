 ...
 * Implementa le interfacce `ServerInterfaceNonLoggato` e
 * `ServerInterfaceLoggato`
...
public class ServerImpl extends UnicastRemoteObject
    ...
    /**
     * @author Stefano Farina
     *         Metodo che registra un nuovo utente nell'applicazione.
     *
    ...
    /**
     * @author Stefano Farina
     *         Metodo che effettua l'accesso di un utente con l'ID utente e la
     *         password forniti.
     *
     ...
     * @throws SQLException    Lanciato in caso di errore nell'accesso al database.
     */
    public synchronized List<Canzone> VisualizzaCanzoniPlaylist(String nomePlaylist, String userID)
            throws RemoteException, SQLException {
    ...
    /**
     * @author Emilio Daverio
     *         Questo metodo è l'entry point principale per avviare il server
     *         dell'applicazione.
     *         Serve per inizializzare e avviare il server RMI per la gestione delle
     *         chiamate remote.
     *         Inoltre, stabilisce una connessione al database.
     *
     * @param args Argomenti da riga di comando (non utilizzati in questo caso).
     * @throws RemoteException Se si verifica un errore di comunicazione remota
     *                         durante l'avvio del server RMI.
     */
